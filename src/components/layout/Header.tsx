...
export function Header({ title, subtitle }: HeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between mb-8 p-6 glass-card border-2">
      <div>
        <h1 className="text-3xl font-black tracking-tight text-foreground animate-pop-in">{title}</h1>
        {subtitle && <p className="text-lg font-medium text-muted-foreground mt-1 animate-fade-in">{subtitle}</p>}
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="gap-2 rounded-xl border-2 font-bold hover:scale-105 transition-transform">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-80 h-12 pl-12 pr-4 rounded-xl bg-card border-2 border-border text-base font-medium placeholder:text-muted-foreground focus:outline-none focus:ring-4 focus:ring-primary/30 focus:border-primary transition-all hover:shadow-lg"
          />
        </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="gap-2 rounded-xl font-bold border-2 hover:scale-105 transition-transform">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-2 p-2 pr-4 rounded-xl bg-card border-2 border-border hover:bg-muted hover:scale-105 transition-all">
